                ...
                try
                {
                    ...
                    foreach (var item in items)
                    {
                        ...
                        if (((int)existsCommand.ExecuteScalar()) > 0)
                        {
                            ...
                            //Don't use the ModifiedUTC time we're told about, because it was generated by the client some time ago and other devices
                            //might have synced since then - we want them to get this update when they next sync.
                            updateCommand.Parameters.Add(new SqlParameter("@mod", (int)(DateTime.UtcNow - new DateTime(1970, 1, 1)).TotalSeconds));
                        ...
                        else
                        {
                            ...
                            //Don't use the ModifiedUTC time we're told about, because it was generated by the client some time ago and other devices
                            //might have synced since then - we want them to get this update when they next sync.
                            insertCommand.Parameters.Add(new SqlParameter("@mod", (int)(DateTime.UtcNow - new DateTime(1970,1,1)).TotalSeconds));
